...
import { ToolbarModule, MimeTypeIconPipe, TranslationService } from '@alfresco/adf-core';
import { ArenderViewerComponent } from './components/arender-viewer/arender-viewer.component';

@NgModule({
  imports: [FlexLayoutModule, MatButtonModule, MatIconModule, CommonModule, ToolbarModule, MatMenuModule, MatProgressSpinnerModule],
  declarations: [ArenderViewerComponent],
  entryComponents: [ArenderViewerComponent],
  exports: [ArenderViewerComponent],
  providers: [ArenderService, { provide: MimeTypeIconPipe, useClass: MimeTypeIconPipe }]
})
