...
//import { AppStore, getAppSelection } from '../../../../aca-shared/store/*';
import { MinimalNodeEntity } from '@alfresco/js-api';

import { ArenderCompareAction, ArenderOpenAction, ARENDER_COMPARE, ARENDER_OPEN } from '../actions/arender.actions';

import { ArenderService } from '../services/arender.service';

@Injectable()
export class ArenderEffects {
  constructor(private store: Store<AppStore>, private actions$: Actions, private arenderService: ArenderService) {}
